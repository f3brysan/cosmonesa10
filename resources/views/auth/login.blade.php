<!doctype html>
<html lang="en" class=" layout-wide  customizer-hide" data-assets-path="{{ asset('backend') }}/assets/"
                ...
                <div class="card px-sm-6 px-0">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-6" action="index.html">
                            ...
                            <div class="mb-6">
                                <a href="{{ route('oauth.google') }}" class="btn btn-primary d-grid w-100 text-center">Login with Google
                                </a>
                            </div>
                        </form>
