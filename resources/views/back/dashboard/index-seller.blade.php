                    ...
                    <div class="col-lg-3 col-md-12 col-3 mb-6">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-3">Rp {{ number_format($getTransactionSuccess->where('payment_status', 'success')->sum('total'), 0, ',', '.') }} </h4>
                                <small class="text-success fw-medium"><i class="icon-base bx bx-up-arrow-alt"></i>
                                    + {{ number_format(count($getTransactionSuccess), 0, ',', '.') }}
                                </small>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12 col-3 mb-6">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <p class="mb-1">New Order</p>
                                <h4 class="card-title mb-3">{{ count($getTransactionSuccess->where('payment_status', 'paid')) }}</h4>                                                               
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12 col-3 mb-6">
                        <div class="card h-100">
                            <div class="card-body">
                                ...
                                <h4 class="card-title mb-3">{{ count($getTransactionSuccess->where('payment_status', 'success')) }}</h4>                                
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-12 col-3 mb-6">
                        <div class="card h-100">
                            <div class="card-body">
                                <div class="card-title d-flex align-items-start justify-content-between mb-4">
                                    <div class="avatar flex-shrink-0">
                                        <h4><i class="icon-base bx bx-wallet text-bg-danger"></i></h4>
                                    </div>
                                </div>
