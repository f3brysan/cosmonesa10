                ...
                <ul>
                    ...
                    @foreach ($images as $i => $img)
                        <li data-index="rs-{{ $i }}" data-transition="random-premium" data-slotamount="default"
                            ...
                            data-easeout="Power3.easeInOut" data-masterspeed="1000" data-thumb="" data-rotate="0" data-title=""
                            data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6=""
                            data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            <img src="{{ asset('storage/'.$img['path']) }}" alt="" data-bgposition="center center"
                            ...
                            <div class="tp-caption headFont ws_nowrap" data-x="['center']" data-hoffset="['0'"
                                ...
                                data-paddingbottom="[0,0,0,250]" data-paddingleft="[0,0,0,20]">
                            </div>
                        </li>
                    @endforeach
                </ul>
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1">
                    <div class="sectionTitle text-center">
                        ...
                        <h2>Our <span class="colorPrimary fontWeight400">Products</span></h2>
                    </div>
                </div>
            </div>
