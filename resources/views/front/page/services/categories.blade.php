        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 offset-lg-1">
                    ...
                    <p class="breadcrumbs"><a href="/">Home</a><span>/</span>service-cat</p>
                </div>
            ...
            <div id="content" class="row">
                <div class="col-lg-3 col-md-6">
                    <div class="serviceItem_01 text-center">
                        ...
                        <h3><a href="{{ URL::to('/services') }}">Stone spa</a></h3>
                        <p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="serviceItem_01 sIlg text-center">
                        ...
                        <h3><a href="{{ URL::to('/services') }}">Candle Massage</a></h3>
                        <p>
                            Risus commodo viverra maecenas accumsan lacus vel facilisis.
                        </p>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="serviceItem_01 sIlg text-center">
                        ...
                        <h3><a href="{{ URL::to('/services') }}">Mortar</a></h3>
                        <p>
                            Risus commodo viverra maecenas accumsan lacus vel facilisis.
                        </p>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="serviceItem_01 text-center">
                        ...
                        <h3><a href="{{ URL::to('/services') }}">Medicine</a></h3>
                        <p>
                            Risus commodo viverra maecenas accumsan lacus vel facilisis.
                        </p>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="serviceItem_01 text-center">
                        ...
                        <h3><a href="{{ URL::to('/services') }}">Nails Design</a></h3>
                        <p>
                            Risus commodo viverra maecenas accumsan lacus vel facilisis.
                        </p>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="serviceItem_01 text-center">
                        ...
                        <h3><a href="{{ URL::to('/services') }}">Hair Cutting</a></h3>
                        <p>
                            Risus commodo viverra maecenas accumsan lacus vel facilisis.
                        </p>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="serviceItem_01 text-center">
                        ...
                        <h3><a href="{{ URL::to('/services') }}">Hair Color</a></h3>
                        <p>
                            Risus commodo viverra maecenas accumsan lacus vel facilisis.
                        </p>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="serviceItem_01 text-center">
                        ...
                        <h3><a href="{{ URL::to('/services') }}">Steam Massage</a></h3>
                        <p>
                            Risus commodo viverra maecenas accumsan lacus vel facilisis.
                        </p>
                    </div>
            ...
            success: function(response) { // Change 'data' to 'response'
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="serviceItem_01 text-center">
                        ...
                        <h3><a href="{{ URL::to('/services') }}">${service.name}</a></h3>
