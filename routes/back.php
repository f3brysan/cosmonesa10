...
Route::group(['middleware' => ['auth', 'role:superadmin|pengelola']], function () {
    ...
    Route::post('event/generate-certificate', [B_EventController::class, 'generateCertificate']);
    Route::get('event/certificate-detail/{id}', [B_EventController::class, 'certificateDetail']);
    ...
    Route::post('product/destroy-images', [B_ProductController::class, 'destroyImages']);
...
Route::group(['middleware' => ['auth', 'role:superadmin|pengelola']], function () {
    ...
    Route::post('master/pengguna/status', [B_UsersController::class, 'deactivate']);
});
